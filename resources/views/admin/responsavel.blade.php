    ...
    <div class="card border">
        <div class="card-body">
            ...
            <form class="form-inline my-2 my-lg-0" method="GET" action="/responsavel/filtro">
                @csrf
                <input class="form-control mr-sm-2" type="text" placeholder="Nome do Responsável" name="nome">
            ...
            <table class="table table-striped table-ordered table-hover">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Login</th>
                        <th>Aluno(s)</th>
                        <th data-toggle="tooltip" data-placement="bottom" title="Nº de Ocorrências não lidas pelo Responsável">Ocorrências</th>
                        <th data-toggle="tooltip" data-placement="bottom" title="Nº de Recados não lidos pelo Responsável">Recados</th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tbody>
